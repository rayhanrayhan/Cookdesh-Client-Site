        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Freshly caught lobster, mixed greens, tomatoes, red onion, and a
                tangy vinaigrette.
              </p>
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Freshly grilled salmon with a zesty citrus salsa on top, served
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
            ...
            />
            <div className="p-6">
              <h2 className="text-2xl font-bold mb-2">Quinoa and Kale Salad</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                A refreshing salad with quinoa, kale, parsley, and feta cheese,
